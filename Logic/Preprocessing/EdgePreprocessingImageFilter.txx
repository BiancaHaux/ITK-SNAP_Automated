...
{  
	...
	ofs << "Entered EdgePreprocessingImageFilter() in EdgePreprocessingImageFilter.txx\n";
	ofs.close();
  ...
  m_BlurFilter->ReleaseDataFlagOn();
	...
	ofs.open("consoleOutput.txt", std::ofstream::out | std::ofstream::app);
	ofs << "Doing BlurFilter in EdgePreprocessingImageFilter() in EdgePreprocessingFilter.txx\n";
	ofs.close();
  ...
  m_GradMagFilter->ReleaseDataFlagOn();
	...
	ofs.open("consoleOutput.txt", std::ofstream::out | std::ofstream::app);
	ofs << "Doing GradientMagFilter in EdgePreprocessingImageFilter() in EdgePreprocessingFilter.txx\n";
	ofs.close();
...
::GenerateData()
{
	std::ofstream ofs;
	ofs.open("consoleOutput.txt", std::ofstream::out | std::ofstream::app);
	ofs << "Entered GenerateData() in EdgePreprocessingImageFilter.txx\n";
	ofs.close();
